...
//             lowest allowable carrier freq              9k
//             highest allowable carrier freq            88k
//             frequency resolution                     1.0k
//             carrrier range as % of Fs              4.30%  35.16%
#define        CARRIER_LOW                               11        // ((CARRIER_FREQ_LOW * FFT_LEN) + SAMPLE_FREQ-1) / SAMPLE_FREQ
#define        CARRIER_HIGH                              90        // (CARRIER_FREQ_HIGH * FFT_LEN) / SAMPLE_FREQ
#define        CARRIER_LEN                               80        // CARRIER_HIGH - CARRIER_LOW + 1
...
//             num bits / frame                         160        bits
//             AFE_SIZE                                   3        words
//             RX_SRC_INC                                 2        words
#define        NUM_DATA_BLOCKS                           14        // CEILING(num_encoded_bits/num_bits_per_frame)
...
//             data field length                      13540        NUM_DATA_FRAMES*(CYCLIC_PREFIX_LEN + FFT_LEN) + WINDOW_LEN
//             receive waveform in Matlab:            17400
//             number of receive buffer frames            8
#if            COMPILE_MODE == MEX_COMPILE
       #define TX_BUFFER_LEN                          16100L       // samples = preamble + data
...
#define        PACKET_TIME                             1006        // number of 16 sample periods in packet
...
#define        DDPHASE_HI_LIM                            75        // upper and lower thresholds for preamble detect
#define        DDPHASE_LO_LIM                            32        //

//---- Frame Align parameters --------------------------------------------------------------
//             Align done % of CARRIER_LEN              55%        //
#define        PHASE_MEAS_LEN                             5        // number of subcarriers to use to compare phase
#define        ALIGN_DONE_CRITERIA                       44        // Criteria for desiding if we've run into the sync field
