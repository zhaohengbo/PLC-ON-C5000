...
//             lowest allowable carrier freq             39k
//             highest allowable carrier freq            88k
//             frequency resolution                     1.0k
//             carrrier range as % of Fs             16.02%  35.16%
#define        CARRIER_LOW                               41        // ((CARRIER_FREQ_LOW * FFT_LEN) + SAMPLE_FREQ-1) / SAMPLE_FREQ
#define        CARRIER_HIGH                              90        // (CARRIER_FREQ_HIGH * FFT_LEN) / SAMPLE_FREQ
#define        CARRIER_LEN                               50        // CARRIER_HIGH - CARRIER_LOW + 1
...
//             num bits / frame                         100        bits
//             AFE_SIZE                                   3        words
//             RX_SRC_INC                                 2        words
#define        NUM_DATA_BLOCKS                           22        // CEILING(num_encoded_bits/num_bits_per_frame)
#define        NUM_SYMBOLS                             1100        // total number of symbols in message
...
#define        DATA_BUFFER_LEN                           69        // words = NUM_SYMBOLS*BITS_PER_SYMBOL*encoder_rate/WORD_LEN

//             preamble+sync length                    2560        NUM_PRE_FRAMES*FFT_LEN + SYNC_FIELD_LEN
//             data field length                      21268        NUM_DATA_FRAMES*(CYCLIC_PREFIX_LEN + FFT_LEN) + WINDOW_LEN
//             receive waveform in Matlab:            25128
//             number of receive buffer frames            8
#if            COMPILE_MODE == MEX_COMPILE
       #define TX_BUFFER_LEN                          23828L       // samples = preamble + data
...
#define        PACKET_TIME                             1489        // number of 16 sample periods in packet
...
#define        DDPHASE_HI_LIM                            47        // upper and lower thresholds for preamble detect
#define        DDPHASE_LO_LIM                            20        //
